output "vpn_connection_id" {
  ...
  value       = "${split(",", (var.create_vpn_connection ? join(",", aws_vpn_connection.*.*.id) : ""))}"
}
...
output "vpn_connection_tunnel1_address" {
  ...
  value       = "${split(",", (var.create_vpn_connection ? join(",", aws_vpn_connection.*.*.tunnel1_address) : ""))}"
}
...
output "vpn_connection_tunnel1_cgw_inside_address" {
  ...
  value       = "${split(",", (var.create_vpn_connection ? join(",", aws_vpn_connection.*.*.tunnel1_cgw_inside_address ) : ""))}"
}
...
output "vpn_connection_tunnel1_vgw_inside_address" {
  ...
  value       = "${split(",", (var.create_vpn_connection ? join(",", aws_vpn_connection.*.*.tunnel1_vgw_inside_address ) : ""))}"
}
...
output "vpn_connection_tunnel2_address" {
  ...
  value       = "${split(",", (var.create_vpn_connection ? join(",", aws_vpn_connection.*.*.tunnel2_address) : ""))}"
}
...
output "vpn_connection_tunnel2_cgw_inside_address" {
  ...
  value       = "${split(",", (var.create_vpn_connection ? join(",", aws_vpn_connection.*.*.tunnel2_cgw_inside_address ) : ""))}"
}
...
output "vpn_connection_tunnel2_vgw_inside_address" {
  ...
  value       = "${split(",", (var.create_vpn_connection ? join(",", aws_vpn_connection.*.*.tunnel2_vgw_inside_address ) : ""))}"
}
